...
import 'package:sparkle/models/user.dart' as model;
import 'package:sparkle/views/screens/auth/login_screen.dart';
import 'package:sparkle/views/screens/home_screen.dart';
...
class AuthController extends GetxController {
  ...
  void pickImage() async {
    ...
    if (pickedImage != null) {
      ...
      _pickedImage.value = File(pickedImage.path); // Update _pickedImage value
    }
  }
